...
$(function () {
  ...
  for (var i = 9; i <= 17; i++) {
      ...
      var element = document.getElementById('hour-' + i);
...
$('.saveBtn').click(function(){
  ...
  var answer = $('.answer').eq(index).val();

  if(answer.trim() !== ''){
    localStorage.setItem('savedAnswer' + index, answer);
    $('header').find('p.confirm').text('saved in Local storage');
  }
});
